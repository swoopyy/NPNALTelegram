...
import ru.mathtech.npntool.npnets.npndiagrams.util.NPNDiagramsResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>npndiagrams</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class NPNDiagramsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new NPNDiagramsResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(NPNDiagramsPackage.eNS_URI, 
			 NPNDiagramsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.npndiagrams")); //$NON-NLS-1$
				NPNDiagramNPNMarked root = NPNDiagramsFactory.eINSTANCE.createNPNDiagramNPNMarked();
