...
import ru.mathtech.npntool.npnets.highlevelnets.tokenexpressions.util.TokenExpressionsResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>tokenexpressions</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenExpressionsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new TokenExpressionsResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(TokenExpressionsPackage.eNS_URI, 
			 TokenExpressionsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.tokenexpressions")); //$NON-NLS-1$
				TokenWeight root = TokenExpressionsFactory.eINSTANCE.createTokenWeight();
