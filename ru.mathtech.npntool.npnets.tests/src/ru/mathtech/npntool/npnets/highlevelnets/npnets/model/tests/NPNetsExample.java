...
import ru.mathtech.npntool.npnets.highlevelnets.npnets.model.util.NPNetsResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>npnets</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class NPNetsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new NPNetsResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(NPNetsPackage.eNS_URI, 
			 NPNetsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.npnets")); //$NON-NLS-1$
				NPnet root = NPNetsFactory.eINSTANCE.createNPnet();
