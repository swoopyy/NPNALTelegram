...
import ru.mathtech.npntool.npnets.highlevelnets.tokentypes.util.TokenTypesResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>tokentypes</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenTypesExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new TokenTypesResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(TokenTypesPackage.eNS_URI, 
			 TokenTypesPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.tokentypes")); //$NON-NLS-1$
				TokenTypeAtomic root = TokenTypesFactory.eINSTANCE.createTokenTypeAtomic();
