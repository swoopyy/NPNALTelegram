...
import ru.mathtech.npntool.npnets.highlevelnets.hlpn.util.HLPNResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>hlpn</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class HLPNExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new HLPNResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(HLPNPackage.eNS_URI, 
			 HLPNPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.hlpn")); //$NON-NLS-1$
				HighLevelPetriNet root = HLPNFactory.eINSTANCE.createHighLevelPetriNet();
