...
/**
 * This is the item provider adapter for a {@link ru.mathtech.npntool.npnets.highlevelnets.tokentypes.Token} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TokenTypesPackage.Literals.TOKEN__ATTRIBUTE);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Token_type") : //$NON-NLS-1$
			getString("_UI_Token_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TokenTypesPackage.Literals.TOKEN__ATTRIBUTE,
				 TokenTypesFactory.eINSTANCE.createTokenAttribute()));
	}
