...
/**
 * This is the item provider adapter for a {@link ru.mathtech.npntool.npnets.highlevelnets.common.INetElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class INetElementItemProvider
	 ...
	 * @generated
	 */
	public INetElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((INetElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_INetElement_type") : //$NON-NLS-1$
			getString("_UI_INetElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(INetElement.class)) {
