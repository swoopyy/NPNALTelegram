...
/**
 * This is the item provider adapter for a {@link ru.mathtech.npntool.npnets.highlevelnets.tokentypes.TokenType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenTypeItemProvider
	 ...
	 * @generated
	 */
	public TokenTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((TokenType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TokenType_type") : //$NON-NLS-1$
			getString("_UI_TokenType_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
