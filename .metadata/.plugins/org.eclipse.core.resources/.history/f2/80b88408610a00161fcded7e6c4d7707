...
/**
 * This is the item provider adapter for a {@link ru.mathtech.npntool.npnets.highlevelnets.tokentypes.Atom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtomItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Atom")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Atom_type") : //$NON-NLS-1$
			getString("_UI_Atom_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
