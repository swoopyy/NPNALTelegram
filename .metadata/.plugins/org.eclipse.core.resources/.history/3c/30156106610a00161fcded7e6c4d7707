...
package ru.mathtech.npntool.npnets.highlevelnets.common.util;
 ...
 * <!-- end-user-doc -->
 * @see ru.mathtech.npntool.npnets.highlevelnets.common.CommonPackage
 * @generated
 */
public class CommonSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CommonPackage.INET_ELEMENT: {
				INetElement iNetElement = (INetElement)theEObject;
				T result = caseINetElement(iNetElement);
				if (result == null) result = caseIEntityIdentifiable(iNetElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.IENTITY_IDENTIFIABLE: {
				IEntityIdentifiable iEntityIdentifiable = (IEntityIdentifiable)theEObject;
				T result = caseIEntityIdentifiable(iEntityIdentifiable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
