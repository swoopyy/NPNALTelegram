...
public interface HLPNPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int NODE__FIRST_TIME_CONSTRAINT = CommonPackage.INET_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NODE__SECOND_TIME_CONSTRAINT = CommonPackage.INET_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int NODE_FEATURE_COUNT = CommonPackage.INET_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int PLACE__FIRST_TIME_CONSTRAINT = NODE__FIRST_TIME_CONSTRAINT;
	 ...
	 * @ordered
	 */
	int PLACE__SECOND_TIME_CONSTRAINT = NODE__SECOND_TIME_CONSTRAINT;
	 ...
	 * @ordered
	 */
	int TRANSITION__FIRST_TIME_CONSTRAINT = CONTEXT_VARIABLE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TRANSITION__SECOND_TIME_CONSTRAINT = CONTEXT_VARIABLE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int TRANSITION__IN_ARCS = CONTEXT_VARIABLE_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int TRANSITION__OUT_ARCS = CONTEXT_VARIABLE_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int TRANSITION_FEATURE_COUNT = CONTEXT_VARIABLE_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int ARC_TP_FEATURE_COUNT = ARC_FEATURE_COUNT + 5;
	...
	/**
	 * Returns the meta object for the attribute '{@link ru.mathtech.npntool.npnets.highlevelnets.hlpn.ArcTP#getFirstTimeConstraint <em>First Time Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>First Time Constraint</em>'.
	 * @see ru.mathtech.npntool.npnets.highlevelnets.hlpn.ArcTP#getFirstTimeConstraint()
	 * @see #getArcTP()
	 * @generated
	 */
	EAttribute getArcTP_FirstTimeConstraint();

	/**
	 * Returns the meta object for the attribute '{@link ru.mathtech.npntool.npnets.highlevelnets.hlpn.ArcTP#getSecondTimeConstraint <em>Second Time Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Second Time Constraint</em>'.
	 * @see ru.mathtech.npntool.npnets.highlevelnets.hlpn.ArcTP#getSecondTimeConstraint()
	 * @see #getArcTP()
	 * @generated
	 */
	EAttribute getArcTP_SecondTimeConstraint();
	...
	/**
	 * Returns the meta object for the attribute '{@link ru.mathtech.npntool.npnets.highlevelnets.hlpn.Node#getFirstTimeConstraint <em>First Time Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>First Time Constraint</em>'.
	 * @see ru.mathtech.npntool.npnets.highlevelnets.hlpn.Node#getFirstTimeConstraint()
	 * @see #getNode()
	 * @generated
	 */
	EAttribute getNode_FirstTimeConstraint();

	/**
	 * Returns the meta object for the attribute '{@link ru.mathtech.npntool.npnets.highlevelnets.hlpn.Node#getSecondTimeConstraint <em>Second Time Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Second Time Constraint</em>'.
	 * @see ru.mathtech.npntool.npnets.highlevelnets.hlpn.Node#getSecondTimeConstraint()
	 * @see #getNode()
	 * @generated
	 */
	EAttribute getNode_SecondTimeConstraint();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>First Time Constraint</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute ARC_TP__FIRST_TIME_CONSTRAINT = eINSTANCE.getArcTP_FirstTimeConstraint();

		/**
		 * The meta object literal for the '<em><b>Second Time Constraint</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute ARC_TP__SECOND_TIME_CONSTRAINT = eINSTANCE.getArcTP_SecondTimeConstraint();
		 ...
		 * @generated
		 */
		EAttribute NODE__FIRST_TIME_CONSTRAINT = eINSTANCE.getNode_FirstTimeConstraint();
		 ...
		 * @generated
		 */
		EAttribute NODE__SECOND_TIME_CONSTRAINT = eINSTANCE.getNode_SecondTimeConstraint();
