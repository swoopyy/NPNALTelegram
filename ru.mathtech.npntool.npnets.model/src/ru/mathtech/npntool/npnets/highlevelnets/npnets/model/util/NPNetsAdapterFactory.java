 ...
 * @generated
 */
public class NPNetsAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected NPNetsSwitch<Adapter> modelSwitch =
		new NPNetsSwitch<Adapter>() {
			@Override
			public Adapter caseNPnet(NPnet object) {
				return createNPnetAdapter();
			}
			@Override
			public Adapter caseNPnetMarked(NPnetMarked object) {
				return createNPnetMarkedAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseTransitionSynchronized(TransitionSynchronized object) {
				return createTransitionSynchronizedAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ru.mathtech.npntool.npnets.highlevelnets.npnets.model.NPnet <em>NPnet</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNPnetAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ru.mathtech.npntool.npnets.highlevelnets.npnets.model.NPnetMarked <em>NPnet Marked</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNPnetMarkedAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ru.mathtech.npntool.npnets.highlevelnets.npnets.model.Synchronization <em>Synchronization</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ru.mathtech.npntool.npnets.highlevelnets.npnets.model.TransitionSynchronized <em>Transition Synchronized</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTransitionSynchronizedAdapter() {
		return null;
	}
